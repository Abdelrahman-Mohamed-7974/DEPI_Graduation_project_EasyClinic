      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 28),
            _buildSwitchItem('Sound Call', soundCall, (val) => setState(() => soundCall = val)),
            const SizedBox(height: 28),
            _buildSwitchItem('Vibrate', vibrate, (val) => setState(() => vibrate = val)),
            const SizedBox(height: 28),
            _buildSwitchItem('Special Offers', specialOffers, (val) => setState(() => specialOffers = val)),
            const SizedBox(height: 28),
            _buildSwitchItem('Payments', payments, (val) => setState(() => payments = val)),
            const SizedBox(height: 28),
            _buildSwitchItem('Promo And Discount', promoAndDiscount, (val) => setState(() => promoAndDiscount = val)),
            const SizedBox(height: 28),
            _buildSwitchItem('Cashback', cashback, (val) => setState(() => cashback = val)),
            const SizedBox(height: 28),
          ],
        ),
      ),
